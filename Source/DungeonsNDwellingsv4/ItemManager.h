...
private:
	...
	UPROPERTY(EditAnywhere)
		TArray<FString> itemPool = { "  ", "Strength-1", "Strength-2", "Strength-3", "Vigor-1", "Vigor-2", "Vigor-3", "Masses-1", "Masses-2", "Masses-3", "Sacrifice-1" }; //0 is no item for the sake of checking the currentAvailableArray;
	UPROPERTY(EditAnywhere)
